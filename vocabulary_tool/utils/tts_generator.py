"""
tts_generator.py - Módulo para gerar arquivos de áudio TTS usando a API do Google.
"""
...
def create_audio_file(text: str, lang_code: str, deck_name: str) -> str:
    """
    Cria um arquivo de áudio .mp3 a partir de um texto.

    Args:
        text: O texto a ser convertido em áudio.
        lang_code: O código do idioma (ex: 'en', 'pt', 'es').
        deck_name: O nome do baralho, usado para organizar os arquivos.

    Returns:
        O nome do arquivo de áudio gerado.
